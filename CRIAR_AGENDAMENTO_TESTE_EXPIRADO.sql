-- ============================================================
-- CRIAR AGENDAMENTO DE TESTE EXPIRADO
-- Execute este SQL para criar um agendamento pending_payment expirado
-- ============================================================

-- Criar um agendamento pending_payment que já está expirado (1 minuto atrás)
...
SELECT 
  ...
  NOW() - INTERVAL '1 minute', -- tolerance_expires_at (expirado há 1 minuto)
...
LIMIT 1
RETURNING id, cliente_nome, cliente_zap, status, tolerance_expires_at;
