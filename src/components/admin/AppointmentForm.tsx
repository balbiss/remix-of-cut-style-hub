...
export function AppointmentForm({
  ...
  const isLoading = loadingProfessionals || loadingServices;
              ...
              <Select value={professionalId} onValueChange={setProfessionalId} required>
                ...
                <SelectContent>
                  {activeProfessionals.length === 0 ? (
                    <SelectItem value="empty" disabled>Nenhum profissional ativo</SelectItem>
                  ) : (
              ...
              <Select value={serviceId} onValueChange={setServiceId} required>
                ...
                <SelectContent>
                  {activeServices.length === 0 ? (
                    <SelectItem value="empty" disabled>Nenhum serviço ativo</SelectItem>
                  ) : (
